...
export default function ProductCardList({ products }: { products: Products[]}) {
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-4 w-full">
            ...
            return (
                ...
                <Link href={`/product/${product.slug}`}>
                    ...
                    <img
                        src={"https://pichpisey.shop/_next/image?url=https%3A%2F%2Fpichpiseyshop.sgp1.digitaloceanspaces.com%2F1745485398221-2.png&w=640&q=100"}
                        alt={product.name}
